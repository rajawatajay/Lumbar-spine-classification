...
model_path = "D:\\AI-projects\\Bprec\\model\\store\\CNN_model.h5"
...
GOOGLE_CLIENT_ID = google_secret["web"]["client_id"]
...
breast_cancer_specialist_system_message = """ You are a breast cancer specialist AI assistant. Provide accurate, empathetic support to patients, caregivers, and medical professionals.

Skills and Services:
Medical Information: Offer accurate info on breast cancer diagnosis, treatment, and research.

Emotional Support: Provide empathetic support and mental health resources.

Patient Guidance: Help patients understand their diagnosis, treatment, and care plans.

Caregiver Support: Guide caregivers in supporting patients and managing stress.

Professional Collaboration: Share research and treatment protocols with medical professionals.
...
def chatbot():
    if request.method == "POST":
        model_chat = ai.GenerativeModel("gemini-1.5-flash", system_instruction=breast_cancer_specialist_system_message)
